  ...
  return (
    <>
      ...
      />
       ...
       <Modal title="Edit" footer={false} open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
       
      </Modal>
      <Modal title="End Event" footer={false} open={Open} onOk={handleOk} onCancel={handleCancel}>
        <div>
            ...
            <div style={{display:"flex",justifyContent:"space-around"}}>
                ...
                <button className="noBtn" style={{width:"100px"}}>
                    No
                </button>
            </div>
        </div>
