            ...
            <div className="side-bar-content">
                ...
                {/* <div style={{ marginTop: "20px" }} className="side-bar-down-section">
                    <Link to={'/admin/notifications'}>
                        <div className={location.includes("/admin/notifications") ? " active-notification" : "notifaction-bell"} >
                            <ReactSVG src={NotificationBells} />
                        </div>
                    </Link> */}
                {/* <div className='notifaction-bell'>
                        <ReactSVG src={Message} />
                    </div> */}
                {/* <div className="side-bar-profile">
                        <Link to={"/admin/profile"} onClick={() => toggle("/admin/profile")}><img className={location.includes("/admin/profile") ? "active-profile" : ""} src={userDetails?.profile_image ? userDetails?.profile_image : ProfilePic} alt="profile" /></Link>
                    </div>
                </div> */}
            </div>
        </div>
